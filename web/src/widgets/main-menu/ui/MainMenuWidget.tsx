...
import { FileJson, Scissors, Minimize, RefreshCw, RotateCw, ImageIcon, Hash } from 'lucide-react';
...
export function MainMenuWidget() {
  return (
    <div className="w-full max-w-4xl mx-auto rounded-lg bg-blue-50 dark:bg-blue-950/30 p-8 shadow-md dark:bg-gray-800">
        ...
        {tools.map((tool) => {
          ...
          return (
            <Link href={tool.href} key={tool.name}>
              <div className="flex items-center p-6 rounded-lg bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-lg min-h-[7.5rem]">
                <div className={`p-4 rounded-full shrink-0 ${tool.bgColor} mr-6`}>
